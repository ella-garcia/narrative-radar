...
export function Dashboard() {
    ...
    function updateVideo(updated) {
        setData((current) => current
            ? {
                ...current,
                top_threats: current.top_threats.map((v) => v.metadata.video_id === updated.metadata.video_id ? updated : v),
            }
            : current);
